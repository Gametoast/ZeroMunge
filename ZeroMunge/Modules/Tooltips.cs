...
namespace ZeroMunge
{
	public static class Tooltips
	{
		...
		public static class Settings
		{
			...
			public const string ShowMungeDirectoryField = "Whether or not to display the Munge Directory field, which lets Zero Munge know where to copy the associated compiled LVL files from.";
