namespace ZeroMunge
{
    partial class SimpleMungePanel
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.check_ingame = new System.Windows.Forms.CheckBox();
			this.check_missions = new System.Windows.Forms.CheckBox();
			this.check_localization = new System.Windows.Forms.CheckBox();
			...
			this.txt_overrideCommand = new System.Windows.Forms.TextBox();
			...
			this.grp_options.Controls.Add(this.check_ingame);
			this.grp_options.Controls.Add(this.check_missions);
			this.grp_options.Controls.Add(this.check_localization);
			...
			// check_ingame
			// 
			this.check_ingame.AutoSize = true;
			this.check_ingame.Checked = true;
			this.check_ingame.CheckState = System.Windows.Forms.CheckState.Checked;
			this.check_ingame.Location = new System.Drawing.Point(8, 129);
			this.check_ingame.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.check_ingame.Name = "check_ingame";
			this.check_ingame.Size = new System.Drawing.Size(89, 24);
			this.check_ingame.TabIndex = 18;
			this.check_ingame.Text = "Ingame";
			this.check_ingame.UseVisualStyleBackColor = true;
			// 
			// check_missions
			// 
			...
			// check_localization
			// 
			this.check_localization.AutoSize = true;
			this.check_localization.Checked = true;
			this.check_localization.CheckState = System.Windows.Forms.CheckState.Checked;
			this.check_localization.Location = new System.Drawing.Point(111, 98);
			this.check_localization.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.check_localization.Name = "check_localization";
			this.check_localization.Size = new System.Drawing.Size(119, 24);
			this.check_localization.TabIndex = 16;
			this.check_localization.Text = "Localization";
			this.check_localization.UseVisualStyleBackColor = true;
			// 
			// check_movies
			// 
			...
			this.group_copyDest.Controls.Add(this.txt_outputFolder);
			...
			// txt_outputFolder
			// 
			this.txt_outputFolder.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txt_outputFolder.Location = new System.Drawing.Point(9, 29);
			this.txt_outputFolder.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.txt_outputFolder.Name = "txt_outputFolder";
			this.txt_outputFolder.Size = new System.Drawing.Size(576, 26);
			this.txt_outputFolder.TabIndex = 0;
			this.txt_outputFolder.TextChanged += new System.EventHandler(this.txt_outputFolder_TextChanged);
			// 
			...
			this.group_overrideCommand.Controls.Add(this.txt_overrideCommand);
			...
			// txt_overrideCommand
			// 
			this.txt_overrideCommand.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txt_overrideCommand.Location = new System.Drawing.Point(122, 28);
			this.txt_overrideCommand.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.txt_overrideCommand.Name = "txt_overrideCommand";
			this.txt_overrideCommand.Size = new System.Drawing.Size(575, 26);
			this.txt_overrideCommand.TabIndex = 0;
			// 
			// btn_copy
			// 
			...
			this.btn_copy.Location = new System.Drawing.Point(852, 91);
        ...
        private System.Windows.Forms.CheckBox check_localization;
        ...
        private System.Windows.Forms.TextBox txt_overrideCommand;
        private System.Windows.Forms.CheckBox check_missions;
        private System.Windows.Forms.CheckBox check_ingame;
