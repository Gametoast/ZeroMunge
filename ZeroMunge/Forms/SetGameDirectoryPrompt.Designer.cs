namespace ZeroMunge
{
	partial class SetGameDirectoryPrompt
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.TopMost = true;
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.SetGameDirectoryPrompt_FormClosed);
			this.Load += new System.EventHandler(this.SetGameDirectoryPrompt_Load);
